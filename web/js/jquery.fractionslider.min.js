    ...
    var r = function(t, n) {
        function v() {
            if (n.controls) {
                ...
                f.find(".next").bind("click",
                function() {
                    return k()
                });
                f.find(".prev").bind("click",
                function() {
                    return C()
                })
            }
            ...
            f.children(".slide").each(function(r) {
                ...
                if (n.pager || t) {
                    var s = e('<a rel="' + r + '" href="#"></a>').bind("click",
                    function() {
                        return N(this)
                    });
                    l.append(s)
        ...
        function U() {
            ...
            i.lastSlide.animate(t, r, "linear",
            function() {
                P()
            })
        }
