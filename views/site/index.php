<div class="home">
    ...
    <div class="section2">
        <div class="container">
            <div class="row">
                ...
                <img class="img-responsive apphome" src="img/apphome.png" alt="">
                </div>
            </div>
        </div>
    </div>
  ...
  <div class="section3 ">
        <div class="container">
            <div class="row">
                <div class="col-sm-4 " style="visibility: visible;">
                <img class="img-responsive apphome" src="img/relationship.png" alt="">
                </div>
    ...
    <div class="section2">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 " style="visibility: visible;">
                <img class="img-responsive apphome2" src="img/koubei.png" alt="">
                </div>
            </div>
        </div>
    </div>
